...
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Core.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Client\CurlHandler.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Client\CurlFactory.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Client\CurlMultiHandler.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Client\Middleware.php');

require(dirname(__FILE__) .'\react\promise\src\PromiseInterface.php');
require(dirname(__FILE__) .'\react\promise\src\PromisorInterface.php');

require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\FutureInterface.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\FutureArrayInterface.php');

require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\BaseFutureTrait.php');

require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\MagicFutureTrait.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\FutureArray.php');

require(dirname(__FILE__) .'\react\promise\src\ExtendedPromiseInterface.php');
require(dirname(__FILE__) .'\react\promise\src\CancellablePromiseInterface.php');

require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Exception\RingException.php');
require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Exception\ConnectException.php');

require(dirname(__FILE__) .'\react\promise\src\functions_include.php');

require(dirname(__FILE__) .'\react\promise\src\FulfilledPromise.php');
require(dirname(__FILE__) .'\react\promise\src\RejectedPromise.php');

require(dirname(__FILE__) .'\guzzlehttp\ringphp\src\Future\CompletedFutureValue.php');
require(dirname(__FILE__) .'\\guzzlehttp\ringphp\src\Future\CompletedFutureArray.php');
