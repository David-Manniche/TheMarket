...
class ProductsController extends MyAppController
{
    ...
    private function getCartForm($formLangId)
    {
        ...
        $frm->addHTML(null, 'btnAddToCart', '<button name="btnAddToCart" type="submit" id="btnAddToCart" class="btn btn-primary btn-block quickView add-to-cart--js "> ' . Labels::getLabel('LBL_Add_to_Cart', $formLangId) . '</button>');
