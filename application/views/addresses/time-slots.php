...
?>
    <li> 
        <input <?php echo ($selectedSlot == $slot['tslot_id']) ? 'checked=checked': ''; ?> type="radio" class="control-input" name="timeSlot" id="<?php echo $slot['tslot_id'] ?>" onclick="selectTimeSlot(this, <?php echo $level;?>);">
