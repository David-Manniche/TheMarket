...
<div class="box box--white box--radius order-summary">
    ...
    <div class="p-4">
        ...
        <?php } else { ?>
        <div class="coupon">
            <a class="coupon-input btn btn-brand btn-block" href="javascript:void(0)"><?php echo Labels::getLabel('LBL_I_have_a_coupon', $siteLangId);?></a>
        </div>
        <?php } ?>
    </div>
            ...
            <table  class="table--justify">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><?php echo CommonHelper::displayMoneyFormat($cartSummary['cartAdjustableAmount']); ?></td>
                    </tr>
                    <?php }?>
