                        ...
                        <div class="">
                            <ul class="list-group list-group-flush list-group-flush-x">
                                <li class="list-group-item">
                                    ...
                                    <span
                                        class="mleft-auto"><?php echo CommonHelper::displayMoneyFormat($cartSummary['cartTotal'], true, false, true, false, true); ?></span>
                                </li>
                                ...
                                <li class="list-group-item hightlighted">
                                    ...
                                    <span
                                        class="mleft-auto"><?php echo CommonHelper::displayMoneyFormat($cartSummary['orderNetAmount'], true, false, true, false, true); ?>
                                    </span>
                                </li>
                            </ul>
