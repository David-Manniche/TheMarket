...
<?php if (count($arrListing) > 0) { ?>
    <div class="cards-header">
        ...
        <div class="action">
            ...
            <!-- <a class="btn btn-outline-primary btn--sm" href="<?php echo CommonHelper::generateUrl('Seller', 'volumeDiscount', array($selprod_id)); ?>" target="_blank"><?php echo Labels::getLabel('LBL_Manage_Volume_Discount', $siteLangId)?></a> -->
        </div>
    </div>
<?php } ?>
