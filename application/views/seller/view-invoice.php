								...
								<td style="border-bottom: 1px solid #ddd;">                                       
									<table width="100%" border="0" cellpadding="10px" cellspacing="0">
										...
										<tr>                                                                         
											...
											<td style="padding:10px 15px;text-align: center;font-weight:700;font-size: 18px;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="1"><strong><?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($orderDetail), true, false, true, false, true); ?></strong></td>                                           
										</tr>
									</tbody></table>                                        
								</td>
							</tr>
