...
$("document").ready(function() {   
        ...
        if(tag_id == ''){
            ...
            fcom.updateWithAjax(fcom.makeUrl('Seller', 'setupTag'), data, function(t) {
                ...
                fcom.updateWithAjax(fcom.makeUrl('Seller', 'tagLangSetup'), dataLang, function(t2) { 
                    fcom.updateWithAjax(fcom.makeUrl('Seller', 'updateProductTag'), 'preq_id='+preq_id+'&tag_id='+t.tagId, function(t3) { 
            ...
            fcom.updateWithAjax(fcom.makeUrl('Seller', 'updateProductTag'), 'preq_id='+preq_id+'&tag_id='+tag_id, function(t) { });
        }        
    }

    removeTagData = function(e){ 
        var tag_id = e.detail.tag.id;
        fcom.updateWithAjax(fcom.makeUrl('Seller', 'removeProductTag'), 'preq_id='+preq_id+'&tag_id='+tag_id, function(t) {
        });
    }
    ...
    addOption = function(e){ 
        ...
        if(option_id == ''){
            ...
            updateProductOption(preq_id, option_id);
        }        
    }
