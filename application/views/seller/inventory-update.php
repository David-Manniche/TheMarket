...
$fld->htmlAfterField = ' <a class = "btn btn-outline-primary btn--sm" href="'.CommonHelper::generateUrl('ImportExport', 'exportInventory').'">'.Labels::getLabel('LBL_Export_CSV_File', $siteLangId).'</a>';
