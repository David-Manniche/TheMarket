                ...
                <div class="col-md-auto">
                    <div class="action">
                        <div class="">
                            ...
                            <?php }?>
                            <a href="<?php echo UrlHelper::generateUrl('Seller', 'sellerProductForm', array($product_id))?>" class="btn btn-outline-brand btn-sm"><?php echo Labels::getLabel('LBL_Add_to_Store', $siteLangId);?></a>
                        </div>
                    </div>
                </div>
