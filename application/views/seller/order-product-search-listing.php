    ...
    foreach ($arr_flds as $key => $val) {
        ...
        switch ($key) {
            ...
            case 'action':
                ...
                if ($shipBySeller && true === $canShipByPlugin && ('CashOnDelivery' == $order['plugin_code'] || Orders::ORDER_PAYMENT_PAID == $order['order_payment_status'] || Orders::ORDER_PAYMENT_DETAINED == $order['order_payment_status'])) {
                    $li = $ul->appendElement("li");
