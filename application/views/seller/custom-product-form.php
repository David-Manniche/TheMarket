...
<?php echo Labels::getLabel('LBL_Product_Attribute_&_Specifications',$siteLangId); ?> 
					 <i class="tabs-icon fa fa-info-circle"  data-toggle="tooltip" data-placement="top" title="<?php echo Labels::getLabel('LBL_Add_Product_Attribute_&_Specifications', $siteLangId); ?>"></i>
