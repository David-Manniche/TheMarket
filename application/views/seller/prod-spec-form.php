        ...
        <div class="col-md-4">
         ...
         <div class="col-md-2">
             <div class="field-set">
                 ...
                 <div class="field-wraper">
                    <div class="field_cover">
                    <button type="button" class="btn btn-outline-primary" onClick="saveSpecification(<?php echo $langId; ?>, <?php if(!empty($prodSpecData)) { echo $prodSpecData[0]['prodspec_id']; } ?>)"><?php echo Labels::getLabel('LBL_Add', $siteLangId) ?></button></div>
                 </div>
             </div>
         </div>
    </div>
