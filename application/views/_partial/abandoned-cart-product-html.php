...
$str = '<tr><td style="padding-right: 25px;"><img style="border: solid 1px #ececec; padding: 10px; border-radius: 4px;" src="'.$prodImage.'"></td><td style="text-align:left;"><span style="font-size: 20px; font-weight:normal; color:#999999;">'.$data['selprod_title'].'</span><span style="font-size: 14px; font-weight: bold; color:#000000; display: block; padding: 20px 0;">'.CommonHelper::displayMoneyFormat($data['selprod_price']).'</span></td></tr>'; 
echo  $str;
