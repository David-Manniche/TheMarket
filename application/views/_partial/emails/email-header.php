                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0">
                        <tbody>
                            <tr>
                                ...
                                <td style="background:#<?php echo FatApp::getConfig('CONF_EMAIL_TEMPLATE_COLOR_CODE'.$langId, FatUtility::VAR_STRING, 'FF3A59'); ?>;padding:15px;text-align:right;">{social_media_icons}</td>
                            </tr>
                        </tbody>
                    </table>
                    <!--header end here-->
