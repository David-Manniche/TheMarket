    ...
    <header id="header-dashboard" class="header-dashboard no-print" role="header-dashboard">
        ...
        <div class="header-icons-group">
            ...
            <ul class="c-header-links">
                <li
                    class="<?php /* echo (($controllerName == 'Seller' || $controllerName == 'Buyer' || $controllerName == 'Advertiser' || $controllerName == 'Affiliate') && $action == 'index') ? 'is-active' : ''; */ ?>">
                    <a title="<?php echo Labels::getLabel('LBL_Dashboard', $siteLangId);?>"
                        data-org-url="<?php echo UrlHelper::generateUrl('home', 'index', array(), '', null, false, $getOrgUrl); ?>"
                        href="<?php echo UrlHelper::generateUrl($controllerName); ?>"><i class="icn icn--dashboard">
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#dashboard"
                                    href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#dashboard"></use>
                            </svg></i></a>
                </li>
                <li><a title="<?php echo Labels::getLabel('LBL_Home', $siteLangId);?>" target="_blank"
                        href="<?php echo UrlHelper::generateUrl('Home'); ?>"><i class="icn icn--home">
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#back-home"
                                    href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#back-home"></use>
                            </svg></i></a></li>
                        ...
                        href="<?php echo UrlHelper::generateUrl('Shops', 'view', array($shop_id)); ?>"><i
                            ...
                            <svg class="svg">
                                <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#manage-shop"
                                    href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#manage-shop"></use>
                            </svg></i></a></li>
                <?php } ?>
            </ul>
            ...
            <div class="c-header-icon bell">
                <a data-org-url="<?php echo UrlHelper::generateUrl('Account', 'Messages', array(), '', null, false, $getOrgUrl); ?>"
                    ...
                    <i class="icn"><svg class="svg bell-shake-delay">
                            <use xlink:href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#notification"
                                href="<?php echo CONF_WEBROOT_URL;?>images/retina/sprite.svg#notification"></use>
                        </svg>
                    </i>
