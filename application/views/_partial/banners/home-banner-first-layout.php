            ...
            foreach ($slideArr as $slideScreen) {
                ...
                switch ($slideScreen['afile_screen']) {
                    case applicationConstants::SCREEN_MOBILE:
                        $mobile_url = FatCache::getCachedUrl(CommonHelper::generateUrl('Banner', 'HomePageBannerTopLayout', array($val['banner_id'], $siteLangId, applicationConstants::SCREEN_MOBILE)).$uploadedTime, CONF_IMG_CACHE_TIME, '.jpg').",";
                        break;
                    case applicationConstants::SCREEN_IPAD:
                        $tablet_url = FatCache::getCachedUrl(CommonHelper::generateUrl('Banner', 'HomePageBannerTopLayout', array($val['banner_id'], $siteLangId, applicationConstants::SCREEN_IPAD)).$uploadedTime).",";
                        break;
                    case applicationConstants::SCREEN_DESKTOP:
                        $defaultImgUrl = FatCache::getCachedUrl(CommonHelper::generateUrl('Banner', 'HomePageBannerTopLayout', array($val['banner_id'], $siteLangId, applicationConstants::SCREEN_DESKTOP)).$uploadedTime, CONF_IMG_CACHE_TIME, '.jpg');
