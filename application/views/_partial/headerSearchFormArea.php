            ...
            <div class="dropdown-menu dropdown-menu-fit dropdown-menu-anim">
                <div class="scroll-y" data-simplebar>
                    <ul class="nav nav-block">
                        ...
                        <li class="nav__item"><a class="dropdown-item nav__link" id="category--js-0" href="javascript:void(0);" onclick="setSelectedCatValue(0)"><?php echo Labels::getLabel('LBL_All', $siteLangId); ?></a>
                        </li>
