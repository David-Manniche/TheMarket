	...
	<div class="js-posts-slider posts-slider" dir="<?php echo CommonHelper::getLayoutDirection();?>">
	 <?php foreach($postList as $blogPost ){ ?>
		<div class="post-item">
			...
			<div class="post-media"><img src="<?php echo CommonHelper::generateUrl('image','blogPostFront', array($blogPost['post_id'],$siteLangId, "BANNER"),CONF_WEBROOT_URL); ?>" data-ratio="16:9" alt="<?php echo (!empty($fileRow['afile_attribute_alt'])) ? $fileRow['afile_attribute_alt'] : $blogPost['post_title'];?>" title="<?php echo (!empty($fileRow['afile_attribute_title'])) ? $fileRow['afile_attribute_title'] : $blogPost['post_title'];?>" class="img"></div>
			<div class="post-data">
