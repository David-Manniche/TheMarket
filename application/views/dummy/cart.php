<div class="body bg-gray-dark" id="body">
                                ...
                                <div class="cart-blocks">
                                    <ul class="list-group list-cart">
                                        <li class="list-group-item">
                                            <div class="info">
                                                <span> <svg class="svg">
                                                        <use xlink:href="../images/retina/sprite.svg#info" href="../images/retina/sprite.svg#info">
                                                        </use>
                                                    </svg> Some of your items are not available for pickup <a href="#" class="link">Ship Entire Order</a></span>
                                        ...
                                        <li class="list-group-item list-saved-later">
                                            <div class="product-profile">
                                                <div class="product-profile__thumbnail">
                                                    <a href="#">
                                                        <img class="img-fluid" data-ratio="3:4" src="../images/products/product-thumb.jpg" alt="...">
                                                    </a></div>
                                                <div class="product-profile__data">
                                                    ...
                                                    <p class="txt-brand pt-2">Not available for pickup</p>
                                                </div>
                                            </div>
                                            <button class="btn btn-outline-primary btn-sm" type="button"> Save for
                                                later</button>
                                    ...
                                    <ul class="list-group list-cart">
                                        <li class="list-group-item">
                                            <div class="product-profile">
                                                ...
                                                <div class="product-profile__data">
                                                    ...
                                                    <p class="save-later"><a href="#">Save for later</a> / <a href="#">Gift
                                                            wrap</a></p>
                                                </div>
                                            </div>
                                            <div class="product-quantity">
                                                <div class="quantity">
                                                    ...
                                                    <input class="qty-input no-focus" data-page="product-view" title="Available Quantity" type="text" name="quantity" value="22">
                                        ...
                                        <li class="list-group-item">
                                            <div class="product-profile">
                                                ...
                                                <div class="product-profile__data">
                                                    <div class="title"><a class="" href="product.html">Sony XBR-65A1E
                                                            65-Inch 4K Ultra HD Smart BRAVIA OLED TV, Works with
                                                            Alexa</a>
                                                    </div>
                                                    <div class="options">
                                                        <p class="">Medium | red</p>
                                        ...
                                        <li class="list-group-item">
                                            <div class="product-profile">
                                                ...
                                                <div class="product-profile__data">
                                                    ...
                                                    <button class="btn btn-outline-primary btn-sm product-profile__btn" type="button">Move to Bag</button>
                                    ...
                                    <div class="card">
                                        <div class="card__section">
                                            <div class="cart-total">
                                                <div class="coupons">
                                                    <button class="btn btn-outline-primary btn-block" data-toggle="modal" href="#modalcoupons"> Apply coupon</button>

                                                </div>
                                                <div class="coupons-applied">
                                                    <div class="">
                                                        <h6>EROS200 Applied</h6>
                                                        <p>You saved additional $152 </p>
                                                    </div>
                                                ...
                                                <ul class="list-group list-group-flush list-group-flush-x">
                                                    ...
                                                    <li class="list-group-item ">
                                                        <span class="label">Tax</span> <span class="ml-auto">$00.00</span>
                                                    </li>

                                                    <li class="list-group-item ">
                                                        <span class="label">Coupon Discount <i class="fas fa-info-circle"></i></span> <span class="ml-auto txt-success"> $152.00</span>
                                                    </li>

                                                    <li class="list-group-item ">
                                                        <span class="label">Shipping</span> <span class="ml-auto"><del>$00.00</del> <span class="txt-success">
                                                                Free</span></span>
                                                    </li>
                                                ...
                                                <p class="included">Tax included. Shipping calculated at checkout</p>

                                                <div class="buttons-group">
                                                    <button class="btn" type="button">Checkout</button>
                                                    <button class="btn" type="button">Shop more</button>
                                                </div>
