                    ...
                    <div class="row">
                        <div class="col-lg-8">
                            <div class="shiporpickup">
                                <ul>
                                    <li><input class="control-input" type="radio" id="shipping" name="shippingType"
                                            checked="">
                                        <label class="control-label" for="shipping">
                                            <svg class="svg">
                                                <use xlink:href="../images/retina/sprite.svg#shipping"
                                                    href="../images/retina/sprite.svg#shipping">
                                                </use>
                                            </svg> Ship My Order
                                        </label>
                                    ...
                                    <li><input class="control-input" type="radio" id="pickup" name="shippingType"
                                        ...
                                        <label class="control-label disabled" for="pickup">
                                            <svg class="svg">
                                                <use xlink:href="../images/retina/sprite.svg#pickup"
                                                    href="../images/retina/sprite.svg#pickup">
                                                </use>
                                    ...
                                    <li class="list-group-item">
                                        <div class="info">
                                            <span> <svg class="svg">
                                                ...
                                                </svg> Some of your items are not available for pickup <a href="#"
                                                    class="link">Ship Entire Order</a></span>
                                    ...
                                    <li class="list-group-item">
                                        <div class="product-profile">
                                            ...
                                            <div class="product-profile__data">
                                                ...
                                                <button class="btn btn-outline-primary btn-sm product-profile__btn"
                                                    type="button">Move to Bag</button>
                                        ...
                                        <div class="cart-total">
                                            <div class="coupons">
                                                <button class="btn btn-outline-primary btn-block" data-toggle="modal"
                                                    href="#modalcoupons"> Apply coupon</button>
                                            ...
                                            <ul class="list-group list-group-flush list-group-flush-x">
                                                ...
                                                <li class="list-group-item ">
                                                    <span class="label">Coupon Discount <i
                                                            class="fas fa-info-circle"></i></span> <span
                                                        class="ml-auto txt-success"> $152.00</span>
                                                </li>

                                                <li class="list-group-item ">
                                                    <span class="label">Shipping</span> <span
                                                        class="ml-auto"><del>$00.00</del> <span class="txt-success">
                                                            Free</span></span>
                                                </li>
