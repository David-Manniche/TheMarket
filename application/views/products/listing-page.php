        ...
        <div class="row">
            <sidebar class="col flex-grow-0 collection-sidebar" id="collection-sidebar" data-close-on-click-outside="collection-sidebar">
                ...
                <div class="bg-gray rounded shop-information p-4">
                    <div class="shop-logo"><img data-ratio="1:1" src="<?php echo CommonHelper::generateUrl('image', 'shopLogo', array($shop['shop_id'], $siteLangId, 'SMALL')); ?>" alt="<?php echo $shop['shop_name']; ?>"></div>
                    <div class="shop-info">
                        <div class="shop-name">
                            <h5>
