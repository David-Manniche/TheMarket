...
$langFld->setfieldTagAttribute('onChange', "editCollectionLangForm(" . $collectionId . ", this.value);");
                            ...
                            <div class="row justify-content-end"> 
                                <div class="col-auto mb-4">
                                    <input class="btn btn-primary" 
                                        ...
                                        onClick="editCollectionLangForm(<?php echo $collectionId; ?>, <?php echo $lang_id; ?>, 1)">
                                </div>
                            </div>
                        <?php } ?> 
