...
$langFld->setfieldTagAttribute('onChange', "questionBankLangForm(" . $qbank_id . ", this.value);");
?>
<div class="col-sm-12">
	...
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
            ...
            <li class="<?php echo (0 == $qbank_id) ? 'fat-inactive' : ''; ?>">
		...
		<div class="tabs_panel_wrap">
            <?php
                        ...
                        if (!empty($translatorSubscriptionKey) && $qbank_lang_id != $siteDefaultLangId) { ?> 
                            <div class="row justify-content-end"> 
                                <div class="col-auto mb-4">
                                    <input class="btn btn-primary" 
                                        type="button" 
                                        value="<?php echo Labels::getLabel('LBL_AUTOFILL_LANGUAGE_DATA', $adminLangId); ?>" 
                                        onClick="questionBankLangForm(<?php echo $qbank_id; ?>, <?php echo $qbank_lang_id; ?>, 1)">
                                </div>
                            </div>
                        <?php } ?> 
