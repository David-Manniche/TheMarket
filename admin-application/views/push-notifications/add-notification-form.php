    ...
    <div class="sectionbody space">
        <div class=" tabs_nav_container  flat">
            <ul class="tabs_nav">
                ...
                <li class="<?php echo 1 > $pNotificationId || 1 > $registeredUsers ? 'fat-inactive' : ''; ?>">
                    <a href="javascript:void(0)" onclick="<?php echo 0 < $pNotificationId && 0 < $registeredUsers ? 'addSelectedUsersForm(' . $pNotificationId . ')' : ''; ?>"><?php echo Labels::getLabel('LBL_SELECTED_USERS', $adminLangId); ?></a>
                </li>   
            </ul>
