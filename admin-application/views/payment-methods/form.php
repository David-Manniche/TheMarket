    ...
    <div class="sectionbody space">
        <div class="tabs_nav_container responsive flat">
            <ul class="tabs_nav">
                ...
                <li class="<?php echo (!$pmethod_id) ? 'fat-inactive' : ''; ?>">
                    <a href="javascript:void(0);" <?php echo ($pmethod_id) ? "onclick='editGatewayLangForm(" . $pmethod_id . "," . FatApp::getConfig('conf_default_site_lang', FatUtility::VAR_INT, 1) . ");'" : ""; ?>>
