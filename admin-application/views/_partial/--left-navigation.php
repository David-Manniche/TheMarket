		...
		<ul class="leftmenu">
			...
			<li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Catalog',$adminLangId);?></a>
				<ul>
					...
					<?php } ?>
					<?php
					if($objPrivilege->canViewBrandRequests(AdminAuthentication::getLoggedAdminId(), true)){ ?>
					...
					<?php } ?>
					<?php
					if($objPrivilege->canViewCategoryRequests(AdminAuthentication::getLoggedAdminId(), true)){ ?>
					<li><a href="<?php echo CommonHelper::generateUrl('CategoryRequests');?>"><?php echo Labels::getLabel('LBL_Category_Requests',$adminLangId);?></a></li>
					<?php } ?>
				</ul>
			</li>
			<?php }?>
			...
			<li><a href="<?php echo CommonHelper::generateUrl('promotions'); ?>"><?php echo Labels::getLabel('LBL_PPC_Promotions_Management',$adminLangId);?></a>
			</li>
			<?php }?>
