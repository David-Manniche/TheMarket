  <!--left panel start here-->
        ...
        <aside class="leftside">
            ...
            <?php if ($objPrivilege->canViewShops(AdminAuthentication::getLoggedAdminId(), true)) { ?>
                <li>
                    <a href="<?php echo CommonHelper::generateUrl('Shops');?>"><?php echo Labels::getLabel('LBL_Shops', $adminLangId);?></a>
                </li>
            <?php } ?>
            ...
            <li class="haschild">
                ...
                <ul>
                    <?php if ($objPrivilege->canViewProducts(AdminAuthentication::getLoggedAdminId(), true)) {?>
                    <li>
                        <a href="<?php echo CommonHelper::generateUrl('sellerProducts', 'specialPrice');?>"><?php echo Labels::getLabel('LBL_Special_Price', $adminLangId);?></a>
                    </li>
                    <?php } ?>
                    <?php if ($objPrivilege->canViewProducts(AdminAuthentication::getLoggedAdminId(), true)) {?>
                    <li>
                        <a href="<?php echo CommonHelper::generateUrl('sellerProducts', 'volumeDiscount');?>"><?php echo Labels::getLabel('LBL_Volume_Discount', $adminLangId);?></a>
                    </li>
                    <?php } ?>
                    <?php if ($objPrivilege->canViewProducts(AdminAuthentication::getLoggedAdminId(), true)) {?>
                    <li>
                        <a href="<?php echo CommonHelper::generateUrl('sellerProducts', 'upsellProducts');?>"><?php echo Labels::getLabel('LBL_Buy_Together_Products', $adminLangId);?></a>
                    </li>
                    <?php } ?>
                    <?php if ($objPrivilege->canViewProducts(AdminAuthentication::getLoggedAdminId(), true)) {?>
                    <li>
                        <a href="<?php echo CommonHelper::generateUrl('sellerProducts', 'relatedProducts');?>"><?php echo Labels::getLabel('LBL_Related_Products', $adminLangId);?></a>
                    </li>
                    <?php } ?>
            ...
            <li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Users', $adminLangId);?></a>
                <ul>
                    ...
                    <li><a href="<?php echo CommonHelper::generateUrl('AdminUsers')?>"><?php echo Labels::getLabel('LBL_Admin_Sub_Users', $adminLangId);?></a>
                    </li>
                    <?php } ?> 
                ...
                <li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_MOBILE_APPS', $adminLangId);?></a>
                    <ul>
                        ...
                        if ($objPrivilege->canViewAppThemeSettings(AdminAuthentication::getLoggedAdminId(), true)) {?>
                            <li>
                                <a href="<?php echo CommonHelper::generateUrl('MobileAppSettings', 'appTheme'); ?>">
            ...
            <li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Tools', $adminLangId);?></a>
                <ul>
                    <li><a href="<?php echo CommonHelper::generateUrl('sentEmails'); ?>"><?php echo Labels::getLabel('LBL_Sent_Emails',$adminLangId);?></a></li>
