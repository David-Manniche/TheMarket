        ...
        <aside class="leftside">
            ...
            <li class="haschild"><a href="javascript:void(0);"><?php echo Labels::getLabel('LBL_Settings', $adminLangId);?></a>
                <ul>
                    ...
                    <?php }?>
					<?php if($objPrivilege->canViewAddons(AdminAuthentication::getLoggedAdminId(), true)){?>
						<li><a href="<?php echo CommonHelper::generateUrl('Addons'); ?>"><?php echo Labels::getLabel('LBL_ADDONS',$adminLangId);?></a></li>
					<?php }?>
