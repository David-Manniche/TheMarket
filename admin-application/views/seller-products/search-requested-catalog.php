...
<div class="sectionhead">
	...
	<a href="javascript:void(0);" onClick="addNewCatalogRequest()" class="themebtn btn btn-brand btn-sm"><?php echo Labels::getLabel('LBL_Request_to_add_catalog',$adminLangId); ?></a>
</div>
