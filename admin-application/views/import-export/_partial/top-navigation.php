...
<ul class="tabs_nav">
    ...
    <li ><a href="javascript:void(0)" onClick="loadForm('bulk_media')" class="<?php echo !empty($action) && $action=='bulkMedia'?'active' : '';?>"><?php echo Labels::getLabel('LBL_Upload_Bulk_Media',$adminLangId); ?></a></li>
