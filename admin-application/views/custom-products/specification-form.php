                ...
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        ...
                        <li class="<?php echo (!$preqId) ? 'fat-inactive' : ''; ?>"><a href="javascript:void(0);"
                                <?php echo ($preqId) ? "onClick='productLangForm( ".$preqId.",".$langId." );'" : ""; ?>><?php echo Labels::getLabel('LBL_'.$langName, $adminLangId);?></a></li>
                        <?php } ?>
                    ...
                    <div class="tabs_panel_wrap">
                        <div class="tabs_panel">
                            <?php  $specCount= (!empty($productSpecifications['prod_spec_name'][CommonHelper::getLangId()])) ? count($productSpecifications['prod_spec_name'][CommonHelper::getLangId()]) : 0; ?>
                        ...
                        $totalSpec = $specKey; ?>
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="field-set">
                                                <div class="field-wraper">
                                                    <div class="field_cover">
                                                        <input class="psec-name-js <?php echo 'layout--'.Language::getLayoutDirection($langId); ?>" title="<?php echo Labels::getLabel('LBL_Specification_Name', $adminLangId)?>"
                                                            value="<?php echo $productSpecifications['prod_spec_name'][$langId][$specKey];?>" placeholder="<?php echo Labels::getLabel('LBL_Specification_Name', $adminLangId)?>" type="text"
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                                            <div class="field-set">
                                                <div class="field-wraper">
                                                    <div class="field_cover">
                                                        <input class="<?php echo 'layout--'.Language::getLayoutDirection($langId); ?>" title="<?php echo Labels::getLabel('LBL_Specification_Value', $adminLangId)?>" type="text"
                                                            value="<?php echo $productSpecifications['prod_spec_value'][$langId][$specKey];?>" placeholder="<?php echo Labels::getLabel('LBL_Specification_Value', $adminLangId)?>"
                                        ...
                                        <div class="col-lg-1 col-md-1 col-sm-4 col-xm-12 align--right">
                                            <?php if ($count != 0) { ?>
                                            <button type="button" onclick="removeSpecDiv(<?php echo $specKey ?>);" class="btn btn--secondary ripplelink" title="<?php echo Labels::getLabel('LBL_Remove', $adminLangId)?>"><i
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                                            <div class="field-set">
                                                <div class="field-wraper">
                                                    <div class="field_cover">
                                                        <input class="<?php echo 'layout--'.Language::getLayoutDirection($langId); ?> psec-name-js" title="<?php echo Labels::getLabel('LBL_Specification_Name', $adminLangId)?>"
                                                            placeholder="<?php echo Labels::getLabel('LBL_Specification_Name', $adminLangId)?>" type="text" name="prod_spec_name[<?php echo $langId ?>][0]" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-5 col-md-5 col-sm-4 col-xs-12">
                                            <div class="field-set">
                                                <div class="field-wraper">
                                                    <div class="field_cover">
                                                        <input class="<?php echo 'layout--'.Language::getLayoutDirection($langId); ?>" title="<?php echo Labels::getLabel('LBL_Specification_Value', $adminLangId)?>"
                                                            placeholder="<?php echo Labels::getLabel('LBL_Specification_Value', $adminLangId)?>" type="text" name="prod_spec_value[<?php echo $langId ?>][0]" value="">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-4 col-xm-12">
                                        <button type="button" class="btn btn--secondary ripplelink right" title="<?php echo Labels::getLabel('LBL_Shipping', $adminLangId)?>" onclick="getCustomCatalogSpecificationForm();"><i
