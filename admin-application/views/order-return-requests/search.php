...
foreach ($arrListing as $sn=>$row){
	...
	foreach ($arr_flds as $key=>$val){
		...
		switch ($key){
			...
			break;
			case 'action':
				$td->appendElement('a', array('href'=>CommonHelper::generateUrl('OrderReturnRequests','view',array($row['orrequest_id'])),'class'=>'btn btn-clean btn-icon','title'=>Labels::getLabel('LBL_View',$adminLangId)),"<i class='ion-eye'></i>", true);					
			break;
			default:
