		...
		switch ($key){
			...
			case 'action':
				...
				if( $canEdit ){
					...
					$li->appendElement('a', array('href'=>'javascript:void(0)', 'class'=>'button small green', 'title'=>Labels::getLabel('LBL_Edit',$adminLangId),"onclick"=>"langForm(".$row['attr_id'].", ". $adminDefaultLangId .")"),'<i class="far fa-edit icon"></i>', true);
				}
			break;
			default:
				$td->appendElement('plaintext', array(), $row[$key], true);
