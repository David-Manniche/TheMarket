...
$langFld->setfieldTagAttribute('onChange', "bannerLangForm(" . $blocation_id . ", this.value);");
?>
...
<div class="col-sm-12">
	<div class="tabs_nav_container responsive flat">
		<ul class="tabs_nav">
            ...
            <li class="active" class="<?php echo (0 == $blocation_id) ? 'fat-inactive' : ''; ?>">
                <a href="javascript:void(0);" <?php echo (0 < $blocation_id) ? "onclick='bannerLangForm(" . $blocation_id . "," . FatApp::getConfig('conf_default_site_lang', FatUtility::VAR_INT, 1) . ");'" : ""; ?>>
                ...
                <div class="row justify-content-end"> 
                    <div class="col-auto mb-4">
                        <input class="btn btn-primary" 
                            ...
                            onClick="bannerLangForm(<?php echo $blocation_id; ?>, <?php echo $banner_lang_id; ?>, 1)">
                    </div>
                </div>
            <?php } ?> 
