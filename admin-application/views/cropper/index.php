    ...
    <div class="text-center rotator-actions" id="actions" >
        <div class="docs-buttons">
            <div class="btn-group">
              ...
              <button type="button" class="btn btn-primary" data-method="rotate" data-option="90" title="<?php echo Labels::getLabel('LBL_Rotate_Right', $adminLangId); ?>">
                <span class="docs-tooltip" data-toggle="tooltip">
            ...
            <div class="btn-group">
              <button type="button" class="btn btn-primary" data-method="scaleX" data-option="-1" title="<?php echo Labels::getLabel('LBL_Flip_Horizontal', $adminLangId); ?>">
                <span class="docs-tooltip" data-toggle="tooltip">
                  <span class="fa fa-arrows-alt-h"></span>
                </span>
              </button>
              <button type="button" class="btn btn-primary" data-method="scaleY" data-option="-1" title="<?php echo Labels::getLabel('LBL_Flip_Vertical', $adminLangId); ?>">
                <span class="docs-tooltip" data-toggle="tooltip">
