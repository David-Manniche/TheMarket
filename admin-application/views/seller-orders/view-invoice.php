									...
									<td style="border-bottom: 1px solid #ddd;">                                       
										<table width="100%" border="0" cellpadding="0" cellspacing="0">
											<tbody><tr>
												...
												<p><strong><?php echo Labels::getLabel('LBL_Payment_Method', $adminLangId);?>:</strong> <?php
						...
						<table width="100%" border="0" cellpadding="0" cellspacing="0">
							<tbody><tr>
								<td style="border-bottom: 1px solid #ddd;">                                       
									<table width="100%" border="0" cellpadding="10px" cellspacing="0">
										<tbody><tr>  
											<th style="padding:10px 15px;text-align: left; border-bottom:1px solid #ddd; "><?php echo Labels::getLabel('LBL_Item', $adminLangId);?></th>
											...
											<?php } ?>
											<th style="padding:10px 15px;text-align: center; border-bottom:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Qty', $adminLangId);?></th>                                                
											<th style="padding:10px 15px;text-align: center; border-bottom:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Price', $adminLangId);?></th>                                             
											<?php /* <th style="padding:10px 15px;text-align: center; border-bottom:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Savings', $adminLangId);?></th> */ ?>                                        
											<th style="padding:10px 15px;text-align: center; border-bottom:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Total_Amount', $adminLangId);?></th>
										</tr>
										<tr> 
										...
										<tr>                                           
											<td style="padding:10px 15px;font-size:18px;text-align: left;font-weight:700;background-color: #f0f0f0;" colspan="2"><?php echo Labels::getLabel('Lbl_Summary', $adminLangId) ?> </td>
										...
										<tr>                                          
											...
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('Lbl_Cart_Total', $adminLangId) ?></td>                    
										...
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Delivery_Charges', $adminLangId) ?></td>                    
										...
										<?php if ($orderDetail['op_tax_collected_by_seller']) { ?>
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Total_Tax', $adminLangId) ?></td>                    
										...
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Reward_Point_Discount', $adminLangId) ?></td>                    
										...
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Tax_Charges', $adminLangId) ?></td>                    
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="1"><?php echo CommonHelper::displayMoneyFormat(CommonHelper::orderProductAmount($orderDetail, 'TAX'), true, false, true, false, true); ?></td>      
										</tr>
										<?php } */ ?>
										<?php
										/* if ($totalSavings != 0) { ?>
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Total_Savings', $adminLangId) ?></td>                    
										...
										if ($rewardPointDiscount != 0) { ?>
										<tr>                                                                              
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><?php echo Labels::getLabel('LBL_Reward_Points', $adminLangId) ?></td>                    
											<td style="padding:10px 15px;text-align: center;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="1"><?php echo CommonHelper::displayMoneyFormat($rewardPointDiscount, true, false, true, false, true); ?></td>      
										</tr>
										<?php } */ ?>
										<tr>                                                                         
											<td style="padding:10px 15px;text-align: center;font-weight:700;font-size: 18px;border-top:1px solid #ddd;border-left:1px solid #ddd;" colspan="2"><strong><?php echo Labels::getLabel('LBL_Grand_Total', $adminLangId) ?></strong> </td>                    
							...
							<tbody><tr>
								...
								<td style="text-align: center;  border:none;">                                       
									<table width="100%" border="0" cellpadding="10px" cellspacing="0" style="">     
										...
										<tr>
											<th style="padding:10px 15px;border:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Tax', $adminLangId); ?></th>
											<th style="padding:10px 15px;border:1px solid #ddd;"><?php echo Labels::getLabel('LBL_Taxable_Amount', $adminLangId); ?></th>
										...
										<tr>
											<td style="padding:10px 15px;text-align: left;border:1px solid #ddd;border-bottom:none;border-right:none;font-size: 12px;background-color: #f0f0f0;" colspan="4">*<?php echo Labels::getLabel('LBL_Appropriated_product-wise_and_Rate_applicable_thereunder', $adminLangId);?></td>                                            
										</tr>
									</tbody></table>                                        
								</td>
								<?php } ?>
