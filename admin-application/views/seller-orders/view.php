                ...
                <section class="section">
                    <div class="sectionhead">
                        ...
                        if (!$print) {
                            ...
                            if (!$shippingHanldedBySeller && true === $canShipByPlugin && ('CashOnDelivery' == $order['plugin_code'] || Orders::ORDER_PAYMENT_PAID == $order['order_payment_status'] || Orders::ORDER_PAYMENT_DETAINED == $order['order_payment_status'])) {
