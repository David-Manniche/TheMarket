...
?>
<div class="portlet">
	<form onsubmit="setupZone(this); return(false);" method="post" class="web_form form_horizontal"
		id="shippingZoneFrm">
			...
			<div class="row">
				<div class="col-md-12">
					<div class="form-group mb-20 zone-main-field--js">
						<input type="text"
							placeholder="<?php echo Labels::getLabel("LBL_Zone_Name", $adminLangId); ?>"
							...
							<label>
								<span class="checkbox" data-zoneid="-1"><input type="checkbox" name="rest_of_the_world"
									...
									<?php echo (in_array(-1, $exZoneIds)) ?'disabled':'';?>><i
										class="input-helper"></i></span><?php echo Labels::getLabel("LBL_REST_OF_THE_WORLD", $adminLangId); ?>
							</label>
						</div>
					</div>
								...
								<div class="row no-gutters">
									...
									<div class="col-auto mr-3">
										...
										<a class="link font-bolder link_<?php echo $countryId;?>"
											...
											data-countryid="<?php echo $countryId;?>"
											data-loadedstates="0"
											onclick="getStates(<?php echo $countryId .','. $zone['zone_id'].','. $profile_id;?>);">
											<span
		...
		<div class="portlet__foot">
			<div class="row">
				<div class="col-md-12">
					<input type="submit" name="btn_submit" value="<?php echo Labels::getLabel("LBL_Add_Zone", $adminLangId); ?>">
					<input type="button" name="cancel"
					onClick="searchProductsSection(<?php echo $profile_id;?>);"
					value="<?php echo Labels::getLabel("LBL_Cancel", $adminLangId); ?>">
				</div>
			</div>
		</div>
	</form>
