					...
					?>
						...
						<div class="row no-gutters">
							...
							<div class="col-auto mr-3">
								...
								<a class="link font-bolder link_<?php echo $countryId;?>" data-toggle="collapse" href="#state_list_<?php echo $countryId;?>" role="button" aria-expanded="false" aria-controls="state_list_<?php echo $countryId;?>" data-countryid="<?php echo $countryId;?>" data-loadedstates="0" onclick="getStates(<?php echo $countryId .','. $zone['zone_id'].','. $profile_id;?>);">
								<span class="statecount--js selectedStateCount--js_<?php echo $countryId;?> " data-totalcount="<?php echo $statesCount; ?>">0</span> <?php echo Labels::getLabel("LBL_of", $adminLangId); ?> <span class="totalStates "><?php echo $statesCount; ?></span> 
								<span class="ion-ios-arrow-down icon"></span>
								</a>
								<?php } ?>
							</div>
						</div>
						<div class="collapse" id="state_list_<?php echo $countryId;?>"></div>
						</li>
					<?php } ?>	
					</ul>
					<?php } ?>
