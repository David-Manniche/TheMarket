...
$logoFld->addFieldTagAttribute('id', 'inputBrandLogoImage');
$logoFld->addFieldTagAttribute('onClick', 'logoPopupImage(this)');
...
$imageFld->addFieldTagAttribute('id', 'inputbrandBannerImage');
$imageFld->addFieldTagAttribute('onClick', 'bannerPopupImage(this)');
                ...
                <div class="tabs_nav_container responsive flat">
                    <ul class="tabs_nav">
                        ...
                        <li class="<?php echo $inactive;?>"><a href="javascript:void(0);"
                            <?php if ($brand_id > 0) { ?>
                                onclick="brandRequestLangForm(<?php echo $brand_id ?>, <?php echo $langId;?>);"
                            <?php }?>>
